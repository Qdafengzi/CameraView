...
public class Camera2MapperTest extends BaseTest {
    ...
    public void testUnmap() {
        ...
        Assert.assertEquals(Facing.BACK, mapper.unmapFacing(LENS_FACING_BACK));
        Assert.assertEquals(Facing.FRONT, mapper.unmapFacing(LENS_FACING_FRONT));
        ...
        Assert.assertEquals(WhiteBalance.AUTO, mapper.unmapWhiteBalance(CONTROL_AWB_MODE_AUTO));
        Assert.assertEquals(WhiteBalance.DAYLIGHT, mapper.unmapWhiteBalance(CONTROL_AWB_MODE_DAYLIGHT));
        Assert.assertEquals(WhiteBalance.CLOUDY, mapper.unmapWhiteBalance(CONTROL_AWB_MODE_CLOUDY_DAYLIGHT));
        Assert.assertEquals(WhiteBalance.INCANDESCENT, mapper.unmapWhiteBalance(CONTROL_AWB_MODE_INCANDESCENT));
        Assert.assertEquals(WhiteBalance.FLUORESCENT, mapper.unmapWhiteBalance(CONTROL_AWB_MODE_FLUORESCENT));
    }
}
