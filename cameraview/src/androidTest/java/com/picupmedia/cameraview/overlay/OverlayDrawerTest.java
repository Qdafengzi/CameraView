package com.picupmedia.cameraview.overlay;
...
import com.picupmedia.cameraview.BaseEglTest;
...
public class OverlayDrawerTest extends BaseEglTest {
    ...
    public void testRender() {
        OverlayDrawer drawer = new OverlayDrawer(mock(Overlay.class), new Size(WIDTH, HEIGHT));
        drawer.mTextureDrawer = Mockito.spy(drawer.mTextureDrawer);
    ...
    public void testRelease() {
        OverlayDrawer drawer = new OverlayDrawer(mock(Overlay.class), new Size(WIDTH, HEIGHT));
        GlTextureDrawer textureDrawer = Mockito.spy(drawer.mTextureDrawer);
