 ...
 */
public class CustomAutoFocusMarker implements AutoFocusMarker {
    ...
    public View onAttach(@NonNull Context context, @NonNull ViewGroup container) {
        View view = LayoutInflater.from(context).inflate(R.layout.cameraview_layout_focus_marker_custom,
                container, false);
